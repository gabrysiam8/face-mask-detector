...
if __name__ == '__main__':
    ...
    data_preparator.download_data(data_path='data/mask.zip',
                                  file_id='1UlOk6EtiaXTHylRUx2mySgvJX9ycoeBp')

    dataset_path = Path('data/self-built-masked-face-recognition-dataset')
    ...
    data_preparator.save_dataframe('data/mask_df.pickle')
